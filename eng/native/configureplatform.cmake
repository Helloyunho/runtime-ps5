...
if(CLR_CMAKE_HOST_OS STREQUAL orbis)
    set(CLR_CMAKE_HOST_UNIX 1)
    if (CMAKE_SYSTEM_PROCESSOR STREQUAL amd64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL x86_64)
        set(CLR_CMAKE_HOST_UNIX_AMD64 1)
    elseif (CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL arm64)
    ...
    set(CLR_CMAKE_HOST_FREEBSD 1)
    set(CLR_CMAKE_HOST_ORBIS 1)
endif(CLR_CMAKE_HOST_OS STREQUAL orbis)
...
if(CLR_CMAKE_TARGET_OS STREQUAL orbis)
    set(CLR_CMAKE_TARGET_ORBIS 1)
    set(CLR_CMAKE_TARGET_UNIX 1)
    set(CLR_CMAKE_TARGET_FREEBSD 1)
endif(CLR_CMAKE_TARGET_OS STREQUAL orbis)
